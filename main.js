...
document.body.innerHTML += '<div id="background" style="position:fixed;width:100vw;height:100vh;top:0;left:0;z-index:500;-webkit-clip-path:url(#svgPath)"><img id="overlay" style="position:fixed;width:100%;height:100%;top:0px;left:0px;z-index:10"></div>';
   ...
   $('#overlay').faceDetection({
        complete: function (faces) {
            for(i = 0; i < faces.length; i++){
               ...
               background.innerHTML += '<div class="face" style="position:fixed;background-color:#be67d8 ;height:'+ faceHeight +'px;width:'+ faceWidth +'px;z-index:400;left:' + faceX + 'px;top:'+ faceY +'px;">';
            }
        }
    });
};
