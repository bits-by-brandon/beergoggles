...
function mouseListen(e){ 
   ...
   clipPath.setAttribute("transform", "translate("+(mouse.x -288)+","+(mouse.y - 90)+") scale(1.83,1.83)");
   
   
//figuring out repaint actions
   //blur.style.webkitClipPath = "url('#svgPath1')"      
}
...
document.onkeydown = function goggleDisable(e){
   ...
   if ( esc == 27){
      ...
      var exist = document.getElementById('blur');
